...
export const Navbar = () => {
  return (
    <nav className="w-full bg-white/10 backdrop-blur-md border-b border-white/20 text-white py-4 z-20">
      <div className="max-w-[1000px] mx-auto px-4 md:px-8 flex justify-between items-center ">
        ...
        {/* Navigation Links */}
        <div className="space-x-4 text-sm md:text-base items-center  flex">
          <Link href="/">
