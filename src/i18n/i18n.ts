...
export const translations = {
  es: {
    ...
    contactDescription: "¿Tenes una idea, proyecto o vacante? Estoy disponible para colaborar en productos web y mobile.",
    ...
    homeTagline: "Fullstack + IA Developer",
  ...
  en: {
    ...
    contactDescription: "Have an idea, project, or open role? I am available to collaborate on web and mobile products.",
    ...
    homeTagline: "Fullstack + AI Developer",
